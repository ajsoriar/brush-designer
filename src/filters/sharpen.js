(function(global) {
                ...
                for (ky = -1; ky <= 1; ky++) {
                    for (kx = -1; kx <= 1; kx++) {
                        ...
                        if (sx >= 0 && sx < width && sy >= 0 && sy < height) {
                            idx = (sy * width + sx) * 4;
                            r += source[idx] * getSharpenWeight(kx, ky);
                            g += source[idx + 1] * getSharpenWeight(kx, ky);
                            b += source[idx + 2] * getSharpenWeight(kx, ky);
                        }
                    }
                }
    ...
    function getSharpenWeight(kx, ky) {
        if (kx === 0 && ky === 0) return 5;
    ...
    global.Filters.sharpen = applySharpen;
